...
func (d *Daemon) startIPAM() {
	...
	d.ipam = ipam.NewIPAM(d.datapath.LocalNodeAddressing(), option.Config, d.nodeDiscovery, d.k8sWatcher, &d.mtuConfig, d.clientset, d.staticIPManager, d.ipamMetadata, option.Config)
